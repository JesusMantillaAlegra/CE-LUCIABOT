...
function hoyExclusivo() {
  // "hoy" como fin de rango exclusivo -- incluye el mes en curso hasta la fecha.
  const d = new Date();
...
export async function refrescarCubos({ historico, presupuestoMs = 240_000 }) {
  const meses = mesesEnRango(CORREO_LLAMADAS_INICIO, hoyExclusivo());
