...
// Llamadas arrancan en julio 2026.
//
// Chat arranca en ABRIL 2026 (ajustado 07-sep-2026, no febrero como se probó primero).
// Se intentó desde febrero, pero la primera corrida en vivo mostró que el tracking por
// hubspot_owner_id=89503870 / inbox_id_objetivo no captura actividad real de Lucía tan
// atrás -- para feb/mar devolvió 0 gestionados/0 escalados en vivo, aunque los datos
// viejos de Breeze (otra metodología, threads/bandejas) sí mostraban actividad real esos
// meses (81 y 203 gestionados respectivamente). Confirmado con
// diagnosticar_gestionados_por_mes.mjs: desde abril el número en vivo ya es no-cero y
// converge razonablemente con la metodología vieja hacia junio-julio-agosto. Decisión de
// Jesús: dejar en vivo desde abril tal cual lo devuelva HubSpot (aceptando que puede diferir
// algo de los números viejos, ya no por un bug sino por metodología/rollout real del bot).
// Febrero y marzo quedan con los snapshots originales de Breeze, restaurados a mano una
// vez vía api/restaurar-chat-historico.mjs -- no se recalculan más (fuera del rango de
// CHAT_INICIO, y de todos modos ya pasaron los 60 días de "mes estable").
export const CORREO_LLAMADAS_INICIO = "2026-07-01";
export const CHAT_INICIO = "2026-04-01";
