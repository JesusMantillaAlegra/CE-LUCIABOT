...
// Llamadas arrancan en julio 2026; Chat arranca en febrero 2026.
//
// OJO (07-sep-2026): para feb/mar, hubspot_owner_id=89503870 / inbox_id_objetivo
// devuelven 0 gestionados/0 escalados en vivo -- se confirmó con
...
// atrás, aunque el bot sí operaba y resolvía casos reales por entonces, ver los
// snapshots viejos de Breeze / la wiki "Estado actual Bot Lucía"). Decisión explícita de
// Jesús: se deja tal cual lo devuelva HubSpot en vivo, NO se restauran los números viejos
// hardcodeados -- el 0 es el dato real bajo la definición vigente, no un placeholder.
