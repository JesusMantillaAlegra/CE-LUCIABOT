  ...
  return {
    ...
    llamadas: {
      kpis: {
        ...
        // filtrado por Agente=Lucía-IVR. Ver llamadasCsat() en lib/hubspot.js para el
        // detalle de por qué se descartan valores fuera de 1-10 (ruido de ingesta).
        csat_promedio: csat.promedio,
        csat_total: csat.total,
      },
      por_version: porVersion,
      motivo_escalamiento,
      _nota_cubo_en_vivo: `Calculado en vivo el ${new Date().toISOString()} por lib/cubos.mjs. CSAT: promedio=${csat.promedio}, total=${csat.total}, descartados_fuera_de_rango=${csat.descartados || 0}${csat.error ? `, ERROR al traer CSAT: ${csat.error}` : ""}.`,
    },
  };
}
