...
//     usuario"). El propio reporte de referencia filtra "Agente = Lucía-IVR" y muestra
//     228 respuestas con promedio 7.86 (resumen con IA de HubSpot, sobre escala 1-10).
//   - OJO: el evento tiene 113 errores de ingesta marcados en HubSpot, y el desglose por
//     "Calificación Encuesta" del reporte de referencia trae valores fuera de rango
//     (65, 90, 110, 125, 1000, etc. junto a los normales 1-10) -- ruido de ingesta, no
//     son calificaciones reales en una escala 1-10. Se descartan acá explícitamente
//     (SURVEYSCORE_MIN/MAX) en vez de promediarlos sin filtrar -- si se promediaran tal
//     cual, un solo valor "1000" arrastraría el promedio muy por encima de la realidad.
//     Los descartados se cuentan aparte (csat.descartados) para poder ver en el dashboard
//     si el % de ruido es alto y hay que revisar esto de nuevo.
